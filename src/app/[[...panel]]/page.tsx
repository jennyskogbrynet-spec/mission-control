    ...
    fetch('/api/status?action=capabilities')
      ...
      .then(async data => {
        ...
        if (Array.isArray(data?.hiddenPanels)) {
          setHiddenPanels(data.hiddenPanels.filter((id: unknown): id is string => typeof id === 'string'))
        }
